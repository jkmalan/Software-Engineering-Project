...
from app.main import db, login, crypt
...
class Users(db.Model):
    ...
    def password(self, pw):
        self.password_hash = crypt.generate_password_hash(pw).decode('utf-8')

    def check_password(self, pw):
        return crypt.check_password_hash(self.password_hash, password=pw)
